    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-card-header">
          <BrandLogo />
          <p className="login-eyebrow">Install · EOS L10</p>
        </div>

        <div className="login-card-body">
          <div className="login-intro">
            <h1 className="login-title">Install Scorecard</h1>
            <p className="login-subtitle">
              Executive view of Install department accountability, KPIs, rocks, and operations
            </p>
          </div>
